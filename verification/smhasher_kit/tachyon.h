...
#define TACHYON_ERROR_NULL_PTR -1
#define TACHYON_ERROR_STATE -2

// =============================================================================
// TYPES
// =============================================================================

// Opaque handle for the streaming state
...
int tachyon_hash_full(const uint8_t *input, size_t len, uint64_t domain, uint64_t seed, const uint8_t *key, uint8_t *out);
...
int tachyon_derive_key(const char *context, size_t context_len, const uint8_t *material, uint8_t *out);
