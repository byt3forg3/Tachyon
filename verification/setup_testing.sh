...
echo ""
echo "  SMHasher:"
echo "    1) SMHasher — Pure C reference"
echo "    2) SMHasher — Rust / libtachyon (native optimized)"
echo ""
echo "  Full suites:"
echo "    3) Full Suite (SMHasher Pure C + PractRand + TestU01)"
echo "    4) Full Suite (SMHasher Rust + PractRand + TestU01)"
echo ""
echo "  Other:"
echo "    5) Install PractRand only"
echo "    6) Install TestU01 only"
echo "    q) Quit"
echo ""
...
if [ "$RAN_SMHASHER" -eq 1 ]; then
    echo "  ▶ To run SMHasher for Tachyon (Avalanche, Speed, Quality):"
